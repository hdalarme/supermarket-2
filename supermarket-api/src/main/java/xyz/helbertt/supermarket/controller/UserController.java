...
public class UserController {
	...
	@PostMapping
	public MessageResponseDTO create(@RequestBody UserDTO userDTO) throws SupermarketMailAlreadyRegisteredException {
		return  service.create(userDTO); 
	}
	
	@PutMapping("/{id}")
	public MessageResponseDTO update(@PathVariable Long id, @RequestBody UserDTO userDTO) throws SupermarketNotFoundException, SupermarketMailAlreadyRegisteredException {
